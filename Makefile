...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/18 15:12:03 by gmeda             #+#    #+#              #
#    Updated: 2019/09/23 22:25:26 by gmeda            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	 ft_isdigit.c ft_isprint.c ft_itoa.c ft_strmapi.c ft_strsplit.c \
	 ...
	 ft_strsub.c ft_strtrim.c ft_tolower.c ft_toupper.c ft_lstdel.c \
	 ft_lstdelone.c ft_lstnew.c ft_lstiter.c ft_lstmap.c ft_lstadd.c
OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
		ft_isdigit.o ft_isprint.o ft_itoa.o ft_strmapi.o ft_strsplit.o \
		...
		ft_strnew.o ft_strnstr.o ft_strrchr.o ft_strstr.o \
		ft_strsub.o ft_strtrim.o ft_tolower.o ft_toupper.o ft_lstdel.o \
		ft_lstdelone.o ft_lstnew.o ft_lstiter.o ft_lstmap.o ft_lstadd.o
